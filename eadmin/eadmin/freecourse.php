...
<section style="margin-top:15px;">
  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <div class="col-lg-4">
        <section class="card">
            <header class="card-header">
                <h4 class="list-group-item-heading">Download Courses</h4>
            </header>
            <div class="card-body">
                              
                              <button type="button" class="btn btn-info btn-block"><i class="fa fa-cloud-download d-block"></i> Download Files</button>
