    ...
    <div class="col-lg-8">
        <section class="card">
            <header class="card-header">
                <h4 class="list-group-item-heading">Quran Learning</h4>
            </header>
    ...
    <div class="col-lg-4">
        <section class="card">
            <header class="card-header">
                ...
                <h5 class="list-group-item-heading">Get All Courses</h5>
                <p>$9/ month</p>
                </button>
            </header>-->
            <div class="card-body">
                              
            <button type="button" class="btn btn-success btn-sm mb-2 btn-block">
            <h5 class="list-group-item-heading">Purchase Courses</h5>
                <p>$29 USD</p>
            </button>
