    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-12">
            <div class="about_first_content _mission">
              ...
              <ul class="work__list">
                  ...
                  <li>Unde necessitatibus omnis ex dolorum velit perspiciatis natus maxime, eaque eveniet accusantium </li>
                  <li>Similique reiciendis quasi, beatae odio dolores assumenda a, praesentium distinctio quam molestias laboru</li>
          ...
          <div class="col-md-6 col-sm-12">
            <div class="img_style weWorks">
              <img src="img/process.png" class="about_second_img">
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#fullpage').fullpage({
                sectionsColor: ['#F8F9F9', '#fff', '#F2F3F4'],
                navigation: true,
