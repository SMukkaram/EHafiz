      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-sm-12">
            <div class="img_style">
              <img src="img/aboutus/about.png" class="about_first_img">
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
  ...
  <div class="section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12">
            <div class="img_style">
              <img src="img/aboutus/mission.png" class="about_second_img">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class=container>
      <div class="row">
        <div class="col-md-12 col-sd-12">
          <h2 class="title_second _aision">e-Hafiz Team</h2>
          <div class="underline_third"></div>
          <ul class="about_vision">
           <li class="islamiScho">
             <img src="img/islamic/azhar.png"  width="229px">
             <h6>Mohd Irshad</h6>
             <p>Islamic scholar</p>
             <div class="heading_fourth"></div>
             <span><i class="fab fa-twitter" style="font-size: 17px;"></i></span><span><i class="fab fa-linkedin-in" style="font-size: 17px;"></i></span><span><i class="fab fa-facebook-f" style="font-size: 17px;"></i></span>
           </li>
           <li class="islamiScho">
            <img src="img/islamic/shaheen.png"  width="229px">
            <h6>Shaheen Khatoon</h6>
            <p>Islamic scholar</p>
            <div class="heading_fourth"></div>
            <span><i class="fab fa-twitter" style="font-size: 17px;"></i></span><span><i class="fab fa-linkedin-in" style="font-size: 17px;"></i></span><span><i class="fab fa-facebook-f" style="font-size: 17px;"></i></span>
          </li>
          <li class="islamiScho">
            <img src="img/islamic/irshad.png"   width="229px">
            <h6>Azhar Ali</h6>
            <p>Islamic scholar</p>
            <div class="heading_fourth"></div>
            <span><i class="fab fa-twitter" style="font-size: 17px;"></i></span><span><i class="fab fa-linkedin-in" style="font-size: 17px;"></i></span><span><i class="fab fa-facebook-f" style="font-size: 17px;"></i></span>
